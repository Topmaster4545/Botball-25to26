...
struct Sensor groundSensorLeft = { 1, 3200 };
struct Sensor groundSensorRight = { 2,3200 };
...
void sidewaysMoveTime(int direction, int time) //1 right, -1 left
{
	mav(3,1250*-direction);
    mav(0,1250*direction);

    mav(2,1250*direction);
    mav(1,1250*-direction);
    msleep(time);
    moveRobot(0);
}
// MAIN FUNCTIONS ----------------------------------
